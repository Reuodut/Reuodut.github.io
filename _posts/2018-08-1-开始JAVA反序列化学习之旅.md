---
layout: post
title: "开始JAVA反序列化学习之旅"
date: 2018-08-01 
description: "近几年反序列化漏洞分析"
tag: 博客 
---   
...
## 正文：
　这边教程是针对与Mac的，[参考链接](http://ibruce.info/2013/11/22/hexo-your-blog/?utm_source=tuicool)
![]({{ "/imag/avatar.jpg" | absolute_url}})
，由于原文讲到的hexo是以前的老版本，所以现在的版本配置的时候会有些改动。
